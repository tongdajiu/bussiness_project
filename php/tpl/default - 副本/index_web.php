...
function scanQrcode(){
	...
	<div class="view">
		...
		<div class="index_top" style="background-image:url(../upfiles/adindex/<?php echo $adInfo[0]->images?>);">
			<div class="index-nav">
				<ul>
					<li><a href="index.php" class="index-nav-index active"></a></li>
					<li><a href="product.php" class="index-nav-allPro"></a></li>
					<?php if(VersionModel::isOpen('integralExchange')) {?>
						<li><a href="integral_product.php" class="index-nav-integral"></a></li>
						<li><a href="help.php" class="index-nav-article"></a></li>
					<?php }else{ ?>
						<li><a href="help.php" class="index-nav-article"></a></li>
						<li><a href="user.php" class="index-nav-member"></a></li>
					<?php } ?>
				</ul>
			</div>
		</div>
