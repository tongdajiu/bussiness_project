...
.popup_a a{display:inline-block;width:48%;padding-bottom:11.4%;margin:5px 1%;background-image:url(upfiles/images/a.png);background-repeat:no-repeat;background-size:100% auto;}
...
.popup_close{position:absolute;right:-12px;top:-12px;width:26px;height:26px;background:url(upfiles/images/close.png) no-repeat;background-size:100% 100%;font-size:0;}

.share{width:100%;height:100%;background:url(upfiles/images/share.png) no-repeat;background-size:100% auto;}
...
<div class="wrapper">
    <div class="bg_top">
        <img src="/upfiles/lottery/turntable/<?php echo $arrLotteryImg->title_image;?>" alt="摇一摇送福利">
    </div><!--头部-->

    <div class="main">
        <img src="/upfiles/lottery/turntable/<?php  echo $arrLotteryImg->background;?>" />
        <div class="shake"><img src="/upfiles/lottery/turntable/<?php echo $arrLotteryImg->turntable;?>" /></div>
        <!--  <div class="myRecord"><a href="shake.php?act=record">我的福利记录</a></div>-->
    </div><!--主体-->
...
//         {
//         	//活动结束
//             var img = 'upfiles/images/sorry2.jpg',
//             pro = '您晚来了一步,  该活动已经结束咯',
//         	btn = '';
//         }
//         else if( state == -102 )
//         {
//         	//机会用光
//             var img = 'upfiles/images/sorry1.jpg',
