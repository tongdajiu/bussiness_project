...
<div class="top_nav">
	<div class="top_nav_title">分销申请</div>
...
<div class="index-wrapper">
    <div class="add-txt">
    	<ul class="add-txt-ul">
    		<li><span class="add-txt-item">真实姓名</span><input id="name" name="name" type="text" value="<?php echo $obj_user->name;?>" class="add-txt-name" placeholder="请填写您的真实姓名"/></li>
