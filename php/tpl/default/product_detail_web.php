...
wx.ready(function(){
	wx.onMenuShareTimeline({
    	...
    	imgUrl: '<?php echo $site;?>upfiles/product/small/<?php echo $obj->image;?>', // 分享图标
	});
...
<div class="view">
	<div id='mySwipe' class='swipe'>
        ...
        <ul class="swiperPager">
        	<li class="active"></li><?php if ( is_array($imageList) ){foreach($imageList as $image){ ?><li></li><?php }} ?>
        </ul>
	</div>
    ...
    <div class="list02-pic-txt">
		...
		<div class="sku-list">
			<dl class="proPrice" style="width:100%;">
				<dd class="sku-new-price" data-price="<?php echo $obj->price;?>" data-store="<?php echo $obj->inventory;?>">
					<span style="font-size:18px;color:#f60;" id="conprice">￥<?php echo $obj->price;?></span>
				</dd>
			</dl>
			...
			<dl class="proPrice" style="text-align:right;">
				<dd style="font-size:14px;padding-right:5px;">库存 <?php echo $obj->inventory;?></dd>
			</dl>
		</div>
    </div>
	...
	<div class="popup_sku_main">
		<div class="sku_pro_info">
			...
			<div>
				...
				<font style="color:#f60;">￥<span id="price_new" style="font-size:18px;color:#f60;"><?php echo $obj->price;?></span></font>
		...
		-->
			<dl class="proSku proSku_quantity">
				...
				<dd class="proSku_stock">库存：<font id="store_menber"><?php echo $obj->inventory;?></font></dd>
			</dl>
