...
define('LOTTERY_SETTING_TABLE',"lottery_setting");
class lottery_settingBean
{
	...
	function updateNew($db,$arrParam,$arrCondition)
	{
		...
		if ( is_array($arrParam) )
		{
			...
			$strSQL = "UPDATE ".LOTTERY_SETTING_TABLE." SET {$strVal} WHERE 1=1 {$strWhere}";
			$rs =  $db->query($strSQL);
		}
	...
	function createNew( $db, $arr )
	{
		...
		if ( is_array($arr) )
		{
			...
			$strSQL = "INSERT INTO ".LOTTERY_SETTING_TABLE." ($strKey) VALUES({$strVal})";
	...
	function get_list( $db, $arrWhere = '', $arrCol = '', $strOrderBy = '' )
	{
		...
		$strSQL = "SELECT {$strCol} FROM ".LOTTERY_SETTING_TABLE." WHERE 1=1 {$strWhere} {$OrderBy}";
	...
	function del( $db, $arrWhere )
	{
		...
		$strSQL = "DELETE FROM ".LOTTERY_SETTING_TABLE." WHERE 1=1 {$strWhere} ";
