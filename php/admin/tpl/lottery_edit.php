...
<input type="hidden" name="lottery_id" value="<?php echo $lotteryInfo->lottery_id?>" />
		...
		<dd>
			<ul class="ottList">
				<li>
                    ...
                    <input type="text" name="subject" value="<?php echo $lotteryInfo->subject ;?>" class="regTxt" />
					<div class="clear"></div>
				</li>
				...
				<li>
                    ...
                    <select class="lottery_type" name="lottery_type">
                    	<?php foreach( $ActivityType as $key=>$activity ){ ?>
                     		<option value="<?php echo $key ?>" <?php echo $lotteryInfo->lottery_type == $key ? 'selected' : '' ?> ><?php echo $activity ?></option>
                    	<?php } ?>
                    </select>
					<div class="clear"></div>
				</li>
                ...
                <li class="active_img active_img_1">
                  ...
                  <input type="file" name="background" />
                   <input type="hidden" name="background_before" value="<?php echo $arrLotterImg->background; ?>" />
                  <?php if($arrLotterImg->background !=''){?>
                  <p style="padding-left:212px;"><img src="../upfiles/lottery/turntable/<?php echo $arrLotterImg->background; ?>" height="100" /></p>                
                  <?php }?>
                  <p class="ottTips"></p>          
                  <div class="clear"></div>
               </li>
               ...
               <li class="active_img active_img_2">
                  ...
                  <input type="hidden" name="title_image_before" value="<?php echo $arrLotterImg->title_image; ?>" />
                  <?php if($arrLotterImg->title_image !=''){?>
                  <p style="padding-left:212px;"><img src="../upfiles/lottery/turntable/<?php echo $arrLotterImg->title_image; ?>" height="100" /></p>
                  <?php }?>
                  <p class="ottTips"></p>
                  <div class="clear"></div>
               </li>
               ...
               <li class="active_img active_img_3">
                  ...
                  <input type="hidden" name="turntable_before" value="<?php echo $arrLotterImg->turntable; ?>" />
                  <?php if($arrLotterImg->turntable !=''){?>
                  <p style="padding-left:212px;"><img src="../upfiles/lottery/turntable/<?php echo $arrLotterImg->turntable; ?>" height="100" /></p>
                  <?php }?>
                  <p class="ottTips"></p>
                  <div class="clear"></div>
               </li>
               ...
               <li class="active_img active_img_4">
                  ...
                  <input type="hidden" name="pointer_before" value="<?php echo $arrLotterImg->pointer; ?>" />
                  <?php if($arrLotterImg->pointer !=''){ ?>
                  <p style="padding-left:212px;"><img src="../upfiles/lottery/turntable/<?php echo $arrLotterImg->pointer; ?>" height="100" /></p>
                  <?php }?>    
                  <p class="ottTips"></p>
                  <div class="clear"></div>
               </li>
               ...
               <li class="active_img active_img_5">
                  ...
                  <input type="file" name="explain_image" />
                   <input type="hidden" name="explain_image_before" value="<?php echo $arrLotterImg->explain_image; ?>" />
                  <?php if($arrLotterImg->explain_image !=''){ ?>
                  <p style="padding-left:212px;"><img src="../upfiles/lottery/turntable/<?php echo $arrLotterImg->explain_image; ?>" height="100" /></p>                
                  <?php }?>
                  <p class="ottTips"></p>
                  <div class="clear"></div>
               </li>
				...
				<li>
                    ...
                    <select class="status" name="status">
	                    <option value="0" <?php if($lotteryInfo->lottery_id){if($lotteryInfo->status ==0){?> selected= "selected"<?php }}?>> 禁用</option>
	                    <option value="1" <?php if($lotteryInfo->lottery_id){if($lotteryInfo->status ==1){?> selected= "selected" <?php }}?>>开启</option>
                    </select>
					<div class="clear"></div>
				</li>
				...
				<!-- <li>
                    ...
                    <input type="text" name="number" value="<?php echo $lotteryInfo->number ;?>" class="regTxt" />
					<div class="clear"></div>
				</li> -->

				<li>
					<label class="labelName">开始时间:<font style="color:#f00;">*</font></label>
                    <input type="text" name="start_time" id="starttime" style="width:160px;background-position:145px center;" class="wdatePicker" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'endtime\');}', dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="<?php if($lotteryInfo->start_time !=''){echo date('Y-m-d', $lotteryInfo->start_time);}?>"/>
					<div class="clear"></div>
				</li>
				
				<li>
					<label class="labelName">结束时间:<font style="color:#f00;">*</font></label>
                    <input type="text" name="end_time" id="endtime" style="width:160px;background-position:145px center;" class="wdatePicker" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'starttime\');}', dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="<?php if($lotteryInfo->end_time !=''){echo  date('Y-m-d', $lotteryInfo->end_time) ;}?>"/>
					<div class="clear"></div>
				</li>
