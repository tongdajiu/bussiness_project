...
<div class="regInfo">
<div class="content_title">添加积分商品信息</div>
 <dl class="ott">
<dd>
<ul class="ottList">
...
<input type="text" name="name" class="regTxt" value="" />
<div class="clear"></div>
</li>
...
<input type="text" id="inventory" value="0" name="inventory" class="regTxt" />
<div class="clear"></div>
</li>

<li>
<label class="labelName">兑换积分（取整数）:<font style="color:#f00;">*</font></label>
<input type="text" id="integral" value="0" name="integral" class="regTxt" />
<div class="clear"></div>
</li>

<li>
<label class="labelName">商品详情:</label>
<div style="margin-left:212px;"><script id="editor" type="text/plain" style="width:500px;height:240px;"></script></div>
