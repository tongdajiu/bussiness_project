...
<form action="?module=integral_orders_action" id="regform" class="cmxform" method="post">
    ...
    <div id="mainCol" class="clearfix">
        <div class="regInfo">
            ...
            <dl class="ott">
                <dd>
                    <ul class="ottList">
						...
						<?php if($obj->delivery_status == 0){ ?>
						<li>
							<label class="labelName">联系电话:</label>
							<input type="text" name="phone" value="<?php echo $obj->phone; ?>" class="regTxt" />
							<div class="clear"></div>
						</li>
						<li>
							<label class="labelName">收货人姓名:</label>
							<input type="text" name="receiver" value="<?php echo $obj->receiver; ?>" class="regTxt" />
							<div class="clear"></div>
						</li>
						<li>
							<label class="labelName">收货地址:</label>
							<input type="text" name="address" value="<?php echo $obj->address; ?>" class="regTxt" />
							<div class="clear"></div>
						</li>
						<?php }else{ ?>
					...
					<?php if($obj->delivery_status == 1){ ?>
						...
						<li id="express_number">
							...
							<input type="text" name="express_number" value="<?php echo $obj->express_number; ?>" class="regTxt" />
							<div class="clear"></div>
						</li>
            ...
            <p class="continue"><input type="submit" class="continue" id="btn_next" value=" 确定 " /><input type="reset" class="continue" onClick="history.go(-1)" value="后退" /></p>
        </div>
    </div>
</form>
<script>
