<form action="?module=attribute_action" id="regform" class="cmxform" method="post" enctype="multipart/form-data">
	...
	<div id="mainCol" class="clearfix">
		<div class="regInfo">
			<div class="content_title">产品属性添加</div>
			<dl class="ott">
				<dd>
					<ul class="ottList">
						<li>
							<label class="labelName">属性名称:<font style="color:#f00;">*</font></label>
							<input type="text" id="attr_name" value="" name="attr_name" class="regTxt" />
							<div class="clear"></div>
						</li>
						<li>
							<label class="labelName">属性值:<font style="color:#f00;">*</font></label>
							<textarea name="attr_value" rows="10" cols="40" wrap="off"></textarea>
							(注：以回车键划分，每一行为一个值)
							<div class="clear"></div>
						</li>
						<li>
