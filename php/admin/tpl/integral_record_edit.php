...
<input type="text" id="pin_id" value="<?php echo $obj->pin_id; ?>" name="pin_id" class="regTxt" /> 
<div class="clear"></div> 
</li> 
<li> 
<label id="name">团购类型0->发起，1->参与，:<font style="color:#f00;">*</font></label> 
<input type="text" id="pin_type" value="<?php echo $obj->pin_type; ?>" name="pin_type" class="regTxt" /> 
<div class="clear"></div> 
</li> 
<li> 
<label id="name">订单id:<font style="color:#f00;">*</font></label> 
<input type="text" id="order_id" value="<?php echo $obj->order_id; ?>" name="order_id" class="regTxt" /> 
<div class="clear"></div> 
</li> 
<li> 
...
<input type="text" id="total_time" value="<?php echo $obj->total_time; ?>" name="total_time" class="regTxt" /> 
<div class="clear"></div> 
</li> 
  </ul> 
   </dd> 
