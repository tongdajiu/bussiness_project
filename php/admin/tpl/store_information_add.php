...
<div class="regInfo">
<div class="content_title">添加门店资料</div>
 <dl class="ott">
<dd>
<ul class="ottList">
<li>
...
<input type="text" id="address" value="" name="address" class="regTxt" />
<div class="clear"></div>
</li>
<li>
...
<input type="text" id="longitude" value="116.808965" readonly name="longitude" class="regTxt" />
<div class="clear"></div>
</li>
<li>
<label class="labelName">纬度:<font style="color:#f00;">*</font></label>
<input type="text" id="latitude" value="23.444796" readonly name="latitude" class="regTxt" />
<div class="clear"></div>
</li>

<li>
<label class="labelName">联系手机:<font style="color:#f00;">*</font></label>
<input type="text" id="mobile" value="" name="mobile" class="regTxt" />
<div class="clear"></div>
</li>
...
<input type="hidden" id="uid" value="" name="uid" class="regTxt" />
<span class="uidName"></span>
...
map.centerAndZoom(new BMap.Point(116.808965,23.444796), 11);
map.addOverlay(new BMap.Marker(new BMap.Point(116.808965,23.444796)));// 创建标注的坐标
