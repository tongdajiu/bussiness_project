					...
					<ul class="ottList">
						<li>
							...
							<select name="vaild_type" id="vaild_type" class="srchField selectField">
								<option value="0">按优惠券生效的时间</option>
								<option value="1">按用户得到优惠券的时间</option>
							</select>
							<div class="clear"></div>
						</li>
						...
						<li>
							...
							<select name="type" id="type" class="srchField selectField">
								<?php foreach( $this->coupon_type as $key=>$coupon ){ ?>
									<option value="<?php echo $key;?>"><?php echo $coupon;?></option>
								<?php } ?>
						...
						<li>
							...
							<input type="text" name="name" placeholder="优惠券名称" class="regTxt" />
							<div class="clear"></div>
						</li>
						...
						<div class="vaild_type_warp">
							<li>
								...
								<input type="text" name="start_time" id="start_time" placeholder="生效时间" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'end_time\');}'})"  class="wdatePicker" />
								<div class="clear"></div>
							</li>
							<li>
								<label class="labelName">有效时间:<font style="color:#f00;">*</font></label>
								<input type="text" name="end_time" id="end_time" placeholder="有效时间" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'start_time\');}'})" class="wdatePicker" />
								<div class="clear"></div>
							</li>
						</div>
						...
						<div class="vaild_type_warp">
							<li>
								...
								<input type="text" name="vaild_date" id="vaild_date" placeholder="用户得到优惠券起的有效天数" class="regTxt" />
								<div class="clear"></div>
							</li>
						</div>
						...
						<div class="type_warp">
							<li>
								...
								<input type="text" name="max_use" id="max_use" placeholder="满" class="regTxt" />
								<div class="clear"></div>
							</li>
						</div>
						...
						<li>
							...
							<input type="text" name="discount" id="discount" placeholder="减" class="regTxt" />
							<div class="clear"></div>
						</li>
