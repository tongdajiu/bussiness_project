...
<div class="content_title">用户地址管理</div>
    ...
    <div id="tablefooter">
        <div id="tablenav" style="width:300px;">
            <div>
                ...
                <a href="javascript://" onclick="return u_status(1);" >已审核</a>&nbsp;|&nbsp;
                <a href="javascript://" onclick="return u_status(0);" >待审核</a>
            </div>
